#!/usr/bin/env python3
"""
Spring AI Community Release Script - Unified Release Automation

Automates releases for Spring AI Community projects with interactive
...
Usage:
    ...
    python3 spring-ai-community-release.py agent-judge 0.1.0
    python3 spring-ai-community-release.py claude-agent-sdk-java 1.0.0
"""
...
PROJECTS = {
    "agent-sandbox": {
        "repo": "spring-ai-community/agent-sandbox",
    ...
    "agent-judge": {
        "repo": "spring-ai-community/agent-judge",
        "description": "Judge framework for evaluating AI agent outputs",
        "group_id": "org.springaicommunity",
        "artifact_id": "agent-judge",
    },
    "spring-ai-agents": {
        "repo": "spring-ai-community/spring-ai-agents",
        "description": "Agent implementations for Spring AI",
        "group_id": "org.springaicommunity",
        "artifact_id": "spring-ai-agents",
    },
    "claude-agent-sdk-java": {
        "repo": "spring-ai-community/claude-agent-sdk-java",
        "description": "Claude Code SDK for Java",
        "group_id": "io.github.anthropics",
        "artifact_id": "claude-code-sdk-parent",
    },
}
...
class ReleaseWorkflow:
    ...
    def display_summary(self):
        ...
        Logger.bold("\n" + "="*60)
        Logger.bold("SPRING AI COMMUNITY RELEASE")
        Logger.bold("="*60)
...
def main():
    parser = argparse.ArgumentParser(
        description="Spring AI Community Release Script",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
    %(prog)s spring-ai-sandbox 0.1.0 --dry-run
    %(prog)s spring-ai-judge 0.1.0
    %(prog)s claude-agent-sdk-java 1.0.0
...
Available Projects:
    ...
    parser.add_argument('--org', default='spring-ai-community',
                       help='GitHub organization (default: spring-ai-community)')
